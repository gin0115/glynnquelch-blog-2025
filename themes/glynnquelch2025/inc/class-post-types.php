...
class Post_Types {
	...
	public function setup_hooks(): void {
		...
		add_action( 'init', array( $this, 'register_software_post_type' ) );
	...
	/**
	 * Registers the Software post type.
	 *
	 * @return void
	 */
	public function register_software_post_type(): void {
		$labels = array(
			'name'                  => _x( 'Software', 'Post Type General Name', 'glynnquelch2025' ),
			'singular_name'         => _x( 'Software', 'Post Type Singular Name', 'glynnquelch2025' ),
			'menu_name'             => __( 'Software', 'glynnquelch2025' ),
			'name_admin_bar'        => __( 'Software', 'glynnquelch2025' ),
			'archives'              => __( 'Software Archives', 'glynnquelch2025' ),
			'attributes'            => __( 'Software Attributes', 'glynnquelch2025' ),
			'parent_item_colon'     => __( 'Parent Software:', 'glynnquelch2025' ),
			'all_items'             => __( 'All Software', 'glynnquelch2025' ),
			'add_new_item'          => __( 'Add New Software', 'glynnquelch2025' ),
			'add_new'               => __( 'Add New', 'glynnquelch2025' ),
			'new_item'              => __( 'New Software', 'glynnquelch2025' ),
			'edit_item'             => __( 'Edit Software', 'glynnquelch2025' ),
			'update_item'           => __( 'Update Software', 'glynnquelch2025' ),
			'view_item'             => __( 'View Software', 'glynnquelch2025' ),
			'view_items'            => __( 'View Software', 'glynnquelch2025' ),
			'search_items'          => __( 'Search Software', 'glynnquelch2025' ),
			'not_found'             => __( 'Not found', 'glynnquelch2025' ),
			'not_found_in_trash'    => __( 'Not found in Trash', 'glynnquelch2025' ),
			'featured_image'        => __( 'Featured Image', 'glynnquelch2025' ),
			'set_featured_image'    => __( 'Set featured image', 'glynnquelch2025' ),
			'remove_featured_image' => __( 'Remove featured image', 'glynnquelch2025' ),
			'use_featured_image'    => __( 'Use as featured image', 'glynnquelch2025' ),
			'insert_into_item'      => __( 'Insert into software', 'glynnquelch2025' ),
			'uploaded_to_this_item' => __( 'Uploaded to this software', 'glynnquelch2025' ),
			'items_list'            => __( 'Software list', 'glynnquelch2025' ),
			'items_list_navigation' => __( 'Software list navigation', 'glynnquelch2025' ),
			'filter_items_list'     => __( 'Filter software list', 'glynnquelch2025' ),
		);

		// Define the Gutenberg template for software posts.
		$template = array(
			// Introduction/Description section (unlocked, can be edited freely).
			array(
				'core/paragraph',
				array(
					'placeholder' => 'Add a brief description of this software...',
				),
			),

			// Links Section (can be deleted if not needed).
			array(
				'core/heading',
				array(
					'level'   => 2,
				...
				array(
					array(
						...
						array(
							...
							'className'   => 'software-link-github button-with-icon',
			...
			// Installation Instructions (locked position).
			array(
				'core/heading',
				array(
					'level'   => 2,
			...
			array(
				'core/group',
				array(
					'className' => 'software-installation',
					'lock'      => array(
						'move'   => true,
						'remove' => true,
					),
				...
				array(
					array(
						'core/paragraph',
						array(
							'placeholder' => 'Add installation instructions here...',
						),
					),
				),
			),

			// Usage Section (locked position).
			array(
				'core/heading',
				array(
					'level'   => 2,
			...
			array(
				...
				array(
					array(
						'core/paragraph',
						array(
							'placeholder' => 'Add usage instructions and examples here...',
						),
					),
				),
			),

			// Other/Additional Information Section (unlocked).
			array(
				'core/heading',
				array(
					'level'   => 2,
		...
		// Add support for gutenberg features like excerpts and custom fields.
		$args = array(
			'label'                 => __( 'Software', 'glynnquelch2025' ),
			'description'           => '',
			'labels'                => $labels,
			'supports'              => array( 'title', 'editor', 'excerpt', 'author', 'thumbnail', 'comments', 'revisions', 'custom-fields' ),
			'taxonomies'            => array( 'category', 'post_tag' ),
			...
			'rest_controller_class' => 'WP_REST_Posts_Controller',
			'template'              => $template,
			'template_lock'         => false, // Allow adding new blocks but keeps locked blocks in place.
		);

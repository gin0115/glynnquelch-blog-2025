 ...
 * Description:             Custom post type and taxonomies for Saggy Pants archive content.
 * Version:                 1.1.0
 ...
 * Text Domain:             saggy-pants-archive
...
define( 'SAGGY_PANTS_ARCHIVE_BASENAME', plugin_basename( __FILE__ ) );
define( 'SAGGY_PANTS_ARCHIVE_DIR_PATH', plugin_dir_path( __FILE__ ) );
define( 'SAGGY_PANTS_ARCHIVE_DIR_URL', plugin_dir_url( __FILE__ ) );

// Load class files.
require_once SAGGY_PANTS_ARCHIVE_DIR_PATH . 'src/class-archive-type-image.php';

// Initialize classes.
add_action( 'init', array( 'Archive_Type_Image', 'init' ), 20 );
...
add_action( 'init', 'saggy_pants_archive_register_post_type' );
...
add_action( 'init', 'saggy_pants_archive_register_type_taxonomy' );
...
add_action( 'pre_get_posts', 'saggy_pants_archive_set_archive_sort_order' );

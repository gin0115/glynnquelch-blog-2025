...
foreach ( glob( WPMU_PLUGIN_DIR . '/*/*.php' ) as $pinkcrab_mu_plugin_file ) {
	$pinkcrab_mu_plugin_data = get_plugin_data( $pinkcrab_mu_plugin_file, false, false );
	if ( ! empty( $pinkcrab_mu_plugin_data['Name'] ) ) {
		require_once $pinkcrab_mu_plugin_file;
	}
}
